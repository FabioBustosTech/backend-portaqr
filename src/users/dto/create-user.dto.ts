import { IsEmail, IsNotEmpty, IsOptional, IsString, MinLength, IsBoolean, IsArray, MaxLength,  } from 'class-validator';
...
export class CreateUserDto {
  ...
  @MaxLength(12, { message: 'El teléfono no puede tener más de 20 caracteres.' })
  @IsOptional()
  phone?: string;
