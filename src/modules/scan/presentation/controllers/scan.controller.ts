...
export class ScanController {
  ...
  async getStats(@Param('idQr') idQr: string, @Tracking() tracking: TrackingContext) {
  ...
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'No autorizado' })
  @HttpCode(HttpStatus.OK)
  async getLocationStats(@Param('idQr') idQr: string, @Tracking() tracking: TrackingContext) {
  ...
  @ApiResponse({ status: HttpStatus.UNAUTHORIZED, description: 'No autorizado' })
  @HttpCode(HttpStatus.OK)
  async getDeviceStats(@Param('idQr') idQr: string, @Tracking() tracking: TrackingContext) {
