...
import { GetQrUseCase } from './get-qr.usecase';
...
describe('GetQrUseCase', () => {
  let useCase: GetQrUseCase;
  ...
  beforeEach(async () => {
    ...
    useCase = module.get(GetQrUseCase);
  ...
  describe('execute', () => {
    it('debe retornar el QR cuando existe', async () => {
    ...
    it('debe lanzar NotFoundException si el QR no existe', async () => {
